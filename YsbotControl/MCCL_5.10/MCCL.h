...
#define EPCIO_AXIS_X					0x0001
#define EPCIO_AXIS_Y					0x0002
#define EPCIO_AXIS_Z					0x0004
#define EPCIO_AXIS_U					0x0008
#define EPCIO_AXIS_V					0x0010
#define EPCIO_AXIS_W					0x0020
#define EPCIO_AXIS_ALL					0x003F
...
#define DDA_FMT_PD						0x0 // Pulse/Dir
#define DDA_FMT_CW						0x1 // CW/CCW
#define DDA_FMT_AB						0x2 // A/B Phase
#define DDA_FMT_NO						0x3 // No pulse output


/////////////////////////////////////////////////////////////////////
// Encoder Type Definitions

#define ENC_TYPE_AB						0x0 // A/B Phase
#define ENC_TYPE_CW						0x1 // CW/CCW
#define ENC_TYPE_PD						0x2 // Pulse/Dir
#define ENC_TYPE_NO						0x3 // No pulse input
...
typedef void(MCC_CALLBACK *LIOISR_EX)(LIOINT_EX*);
typedef void(MCC_CALLBACK *ENCISR_EX)(ENCINT_EX*);
typedef void(MCC_CALLBACK *RIOISR_EX)(RIOINT_EX*);
...
#endif // !defined(_EPCIO_DEV_H_) && !defined(_ACTADRV_H_)
