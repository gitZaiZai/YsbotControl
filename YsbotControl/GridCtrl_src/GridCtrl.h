...
public:
    ...
    BOOL Create(const RECT& rect, CWnd* parent, UINT nID,
				...
				HBITMAP hBmpScroolBar = NULL,
				HBITMAP hBmpPlus      = NULL,
				HBITMAP	hBmpMinus     = NULL,
				SkinWindowKind nWndKind = SKIN_WINDOW_VARIABLE,
				int baroffset = 0 );
	
	void invalidate_sel_bottom();
...
public:
	...
	HBITMAP	m_hBmpMinus;			 
	BOOL    m_bShowHorzSrollBar;
	BOOL    m_bShowVertSrollBar;

	BOOL    m_bShowVertSrollBarWindow; // liurundan

	CSkinScrollWnd * m_ScrollBarWnd;
	int m_lastDownScrollPos;
///// LUC ///////////////////////////////////////////////////////////////////////

	//// LUC : MergeCell////////
	void SetShowSrollBar(UINT bar, BOOL bshow);
...
public:
	...
	void ExpandColumn(int nCol, int width, BOOL bExpandToFit = FALSE); // liurundan
	void SetHighLightBackColour( COLORREF bkClr ) { m_crHighLightBackClr = bkClr; }
	void SetHighLightTextColour( COLORREF textClr ) { m_crHighLightTextClr = textClr; }
	COLORREF GetBkHighLightColour() { return m_crHighLightBackClr; }
	COLORREF GetTextHighLightColour() { return m_crHighLightTextClr; }
	void SetShowImageCombobox (BOOL bshow = TRUE) { m_bShowImageCombobox = bshow; }
	BOOL IsShowImageCombobox () { return m_bShowImageCombobox; }
...
public:
	...
	static int CALLBACK pfnCustomCompare(LPARAM lParam1, LPARAM lParam2, LPARAM lParamSort);
...
public:
    virtual ~CGridCtrl();
    LRESULT SendMessageToParent(int nRow, int nCol, int nMessage) const; // liurundan
...
protected:
	...
	virtual void  OnEndEditCellInPlace( int nRow, int nCol, CString str, DWORD data );
...
protected:
    ...
    COLORREF    m_crHighLightBackClr, m_crHighLightTextClr;       // liurundan
    BOOL        m_bShowImageCombobox;
...
protected:
	...
	afx_msg void OnBeginInPlaceEdit(NMHDR* pNMHDR, LRESULT* pResult); // liurundan
    DECLARE_MESSAGE_MAP()
