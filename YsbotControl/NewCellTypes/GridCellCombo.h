...
public:
    void  SetOptions(const CStringArray& ar, BOOL bDrawArrow = FALSE, LPCTSTR strSeparator = NULL );
	void  SetTwoTypeOptions(const CStringArray& arFirstType, const CStringArray& arSecondType, BOOL bDrawArrow = FALSE, LPCTSTR strSeparator = NULL );
...
protected:
    ...
    DWORD        m_dwStyle;
	CRect        m_ScrollRect;
	BOOL         m_DrawArrowAlways;
	LPCTSTR      m_strSeparator;
...
class CInPlaceList : public CIconComboBox
{
...
public:
	CInPlaceList(CWnd* pParent,         // parent
				 ...
				 UINT nFirstChar,
				 LPCTSTR strSeparator = NULL );      // first character to pass to control
