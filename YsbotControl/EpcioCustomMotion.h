#ifndef epcio_custom_motion_h
#define epcio_custom_motion_h
...
class EpcioCustomMotion
{
public:
	EpcioCustomMotion(EpcioBase&);
	virtual ~EpcioCustomMotion(void);
