...
BOOL CRefCoSysSetting::Create(CString caption,DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID)
{
	...
	label_joint[6].Create(_T("基坐标系"),WS_CHILD|WS_VISIBLE,CRect(10,35,300,65),this );
	label_joint[6].SetFont(20);
	label_joint[7].Create(_T("以基坐标系为参考的位置和姿态"),WS_CHILD|WS_VISIBLE,CRect(10,120,300,140),this );
