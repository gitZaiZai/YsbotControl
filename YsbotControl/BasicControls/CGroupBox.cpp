...
void CGroupBox::SetCaption(CString Caption)
{
    m_Caption = Caption;
    SetWindowText(_T(""));
}
...
void CGroupBox::OnPaint() 
{
    ...
    CFont m_cfont;
    CString m_caption;
    CPen cpshadow(PS_SOLID,1,RGB(0, 0, 0));
...
void CGroupBox::SetStyle(Aling style)
{
    m_style=style;
}
 
void CGroupBox::OnSysColorChange() 
{
    m_clrface = RGB(233, 233, 233);
    m_clrShadow = RGB(0, 0, 0);
