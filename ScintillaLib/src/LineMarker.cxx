...
//			Point::FromInts(centreX + 2*dimOn2, centreY),
		};
...
// 			Point::FromInts(centreX, centreY - dimOn2),
// 			Point::FromInts(centreX, centreY - dimOn4 + 2 ),
// 			// 			Point::FromInts(centreX - dimOn4, centreY - dimOn4), // liurundan edit
// 			// 			Point::FromInts(centreX - dimOn4, centreY + dimOn4),
// 			Point::FromInts(centreX - 2*dimOn4+2, centreY - dimOn4+2), // liurundan edit
// 			Point::FromInts(centreX - 2*dimOn4+2, centreY + dimOn4-2),
// 			Point::FromInts(centreX, centreY + dimOn4-2),
// 			Point::FromInts(centreX, centreY + dimOn2 ),
			Point::FromInts(centreX, centreY + dimOn2),
			Point::FromInts(centreX + dimOn2, centreY),
			...
			// 			Point::FromInts(centreX - dimOn4, centreY - dimOn4), // liurundan edit
			// 			Point::FromInts(centreX - dimOn4, centreY + dimOn4),
			Point::FromInts(centreX - 2*dimOn4-2, centreY - dimOn4), // liurundan edit
			Point::FromInts(centreX - 2*dimOn4-2, centreY + dimOn4),
			Point::FromInts(centreX, centreY + dimOn4),
			Point::FromInts(centreX, centreY + dimOn2 ),		};
		surface->Polygon(pts, ELEMENTS(pts), fore, back);
